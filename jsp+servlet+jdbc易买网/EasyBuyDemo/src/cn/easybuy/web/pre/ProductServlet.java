...
public class ProductServlet extends AbstractServlet {
    ...
    public String queryProductList(HttpServletRequest request, HttpServletResponse response) throws Exception{
        String category = request.getParameter("category");//这里面的category是从index.jsp传过来的分类id
        ...
        List<ProductCategoryVo> productCategoryVoList = productCategoryService.queryAllProductCategoryList();//以便于在/pre/product/queryProductList页面显示一级分类
    ...
    public String queryProductDeatil(HttpServletRequest request, HttpServletResponse response) throws Exception{
        ...
        request.setAttribute("productCategoryVoList", productCategoryVoList);//用于到ProductDeatil.jsp显示
