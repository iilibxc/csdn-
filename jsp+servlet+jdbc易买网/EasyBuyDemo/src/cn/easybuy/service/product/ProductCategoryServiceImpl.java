...
public class ProductCategoryServiceImpl implements ProductCategoryService {
    ...
    public List<ProductCategoryVo> queryAllProductCategoryList() {
        ...
        //查询一级分类//因为一级分类的父id是0
        List<ProductCategory> productCategory1List = getProductCategories(null);//根据父ID查询所有子商品分类
        //查询二级分类
        for (ProductCategory product1Category : productCategory1List) {
            ...
            productCategory1VoList.add(productCategoryVo);//每查询一个一级分类实体，就将它添加到一级分类的list中
        }
        return productCategory1VoList;//返回由所有的一级分类组成的集合
    }
    /**
     * 查询子分类
     * @param parentId
