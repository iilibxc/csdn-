<%@page import="cn.easyBuy.web.servlet.NewsServlet"%>
...
<div class="soubg">
	<div class="sou">
        ...
        <span class="fr">
        	...
        	<c:otherwise>
        	  你好：${sessionScope.sessionUser.loginName }
        	</c:otherwise>
        	</c:choose>
...
<div class="i_bg bg_color">
	<div class="i_ban_bg">
        ...
        <div class="inews">
        	<div class="news_t">
            	<span class="fr"><a href="${ctx}/NewsServlet?method=queryNextList">更多 ></a></span>新闻资讯          	                       	
            </div>
            
            <ul>
            <c:forEach items="${nList}" var="temp">
            <li><span>[公告]</span>
             <a href="${ctx}/NewsServlet?method=newDeatil&id=${temp.id}">${temp.title }</a>
            </li>
            </c:forEach>
             </ul>
...
<div class="top">
    <div class="logo"><a href="${ctx}/Home?action=index"><img src="${ctx}/statics/statics/images/logo.png"></a></div>
    <div class="search">
        <form>
