		...
		<div class="reg_c">
            ...
            <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
              ...
              <tr height="50">
                ...
                <td><input type="password" name="repassword" value="" class="l_pwd" /></td>
              </tr>
              <tr height="50">
              ...
              <tr height="50">
                ...
                <td><input type="text" name="identityCode" value="" class="l_num" /></td>
              </tr>
              <tr height="50">
                ...
                <td>
                    ...
                    <a href="javascript:changeOne()" style="font-size:12px; font-family:'宋体';">换一张</a>      
